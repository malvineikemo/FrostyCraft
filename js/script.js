...
const config = {
    serverInfo: {
        ...
        serverName: "FrostyCraft", /*Server name*/
        serverIp: "mc.frosty.xyz", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1202263732881981491" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
